...
#### Figure 5: One trainee in a particular `StopYear` is the main case
...
pic1  + pic2
```
#### Figure 6: And again a story about the structure of the data by year 
...
### How mentors and interns are matched
